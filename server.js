...
app.get("/:url", async (req, res) => {
  ...
  if (taskResponse.items!==null) {
    res.json({
      ...
      plain_text_rate:
        taskResponse[0].items[0].meta.content.plain_text_rate.toFixed(2),
      plain_text_word_count:
        taskResponse[0].items[0].meta.content.plain_text_word_count.toFixed(2),
      automated_readability_index:
        taskResponse[0].items[0].meta.content.automated_readability_index.toFixed(
          2
        ),
      coleman_liau_readability_index:
        taskResponse[0].items[0].meta.content.coleman_liau_readability_index.toFixed(
          2
        ),
      dale_chall_readability_index:
        taskResponse[0].items[0].meta.content.dale_chall_readability_index.toFixed(
          2
        ),
      flesch_kincaid_readability_index:
        taskResponse[0].items[0].meta.content.flesch_kincaid_readability_index.toFixed(
          2
        ),
      ...
      description_to_content_consistency:
        taskResponse[0].items[0].meta.content.description_to_content_consistency.toFixed(
          2
        ),
      title_to_content_consistency:
        taskResponse[0].items[0].meta.content.title_to_content_consistency.toFixed(
          2
        ),
      time_to_interactive:
      ...
      size:
        taskResponse[0].items[0].size >=
        taskResponse[0].items[0].total_dom_size,
